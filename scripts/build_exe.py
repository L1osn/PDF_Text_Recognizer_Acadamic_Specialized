...
def build_exe():
    ...
    args = [
        ...
        "--hidden-import=scripts.Pdf_to_text",  # Explicitly include Pdf_to_text module
        "--hidden-import=engine",  # Explicitly include new citation engine package
        "--hidden-import=engine.types",
        "--hidden-import=engine.pipeline",
        "--hidden-import=engine.page_model",
        "--hidden-import=engine.page_model.model",
        "--hidden-import=engine.bib",
        "--hidden-import=engine.bib.extractor",
        "--hidden-import=engine.channels",
        "--hidden-import=engine.channels.bracket",
        "--hidden-import=engine.channels.superscript",
        "--hidden-import=engine.fusion",
        "--hidden-import=engine.fusion.fuser",
